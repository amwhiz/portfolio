...
@Entity({ tableName: 'eCommerceProductVariants' })
export class EcommerceProductsVariant {
  ...
  @Enum({ items: () => ProductVariantSkuEnum, type: 'enum', nullable: true, default: null, index: true })
